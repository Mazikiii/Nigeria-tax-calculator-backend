...
pub struct MediaForm {
    ...
    file: Vec<TempFile>, // whether its one thing or more its type is tempFile and always put it in a vec
...
pub async fn check_batch(files: MultipartForm<MediaForm>) -> impl Responder {}
